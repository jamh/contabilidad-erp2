...
@Embeddable
public class ErpFeTrasladoDrId implements java.io.Serializable{
    ...
    public ErpFeTrasladoDrId(){
        
    }
    
    public ErpFeTrasladoDrId(String compania, int numero, int idDocRel, int id,int idPago){
