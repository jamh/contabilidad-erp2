...
@Entity
@Table(name = "ERP_FE_CONCEPTOXTRASLADO")
public class ErpFeConceptoXTraslado implements java.io.Serializable{
    ...
    private ErpFeConceptoXTrasladoId id;
    ...
    public ErpFeConceptoXTraslado (){
    
    
    }
    
    public ErpFeConceptoXTraslado(ErpFeConceptoXTrasladoId id){
        
        this.id = id;
    
    }

    public ErpFeConceptoXTrasladoId getId() {
        return id;
    }

    public void setId(ErpFeConceptoXTrasladoId id) {
        this.id = id;
    }
