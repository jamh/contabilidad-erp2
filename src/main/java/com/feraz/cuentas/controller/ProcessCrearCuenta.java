...
public class ProcessCrearCuenta {
...
//        System.out.println("Tipo de compania"+ tipoCompania);
       ...
       System.out.println("txtNombre2:"+nombre2);
...
//            if(banderaTrans != "" || banderaTrans != null){
//                
...
//                  mapTrans.put("cuenta_nueva", "1");
//                  mapTrans.put("cuenta_vieja", ctaCompleTrans);
//
//                  int val = processDao.execute(store, mapTrans);
//                  
//                  boolean detPolCta = detPolizasDao.updateCtaDetPolizas(compania, "1", ctaCompleTrans);
//                  
//                  boolean ctaAfectable = cuentasDao.updatePorAfectable(compania, ctaCompleTrans);
//          
//                
//                
//                
                        ...
                        // System.out.println("estructuraCuenta"+estructuraCuenta);
                         ...
                         estructuraBandera = true;
                            ...
                            cuentas.setBanco(banco);
                             ...
                             if(save.getCuenta() == "" || save.getCuenta() == null){
