 ...
 */
package com.feraz.interfaz.cxc;
...
public class ViewInterfazCXC {
    
      @RequestMapping(value = "/interfazCXC",method = RequestMethod.GET)
    public String inicio(@RequestParam(value = "compania") String compania ,@RequestParam(value = "user") String user,Model model) {      
        ...
        return "init/indexInterfazCXC";
    }
    
     @RequestMapping(value = "/interfazCXC",method = RequestMethod.POST)
