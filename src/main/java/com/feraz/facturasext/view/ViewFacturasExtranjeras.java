 ...
 */
package com.feraz.facturasext.view;
...
public class ViewFacturasExtranjeras {
    
    @RequestMapping(value = "/facturasext",method = RequestMethod.GET)
    public String inicio(@RequestParam(value = "compania") String compania ,@RequestParam(value = "user") String user,Model model) {      
        ...
        return "init/FacturasExt";
    }
    
     @RequestMapping(value = "/facturasext",method = RequestMethod.POST)
