...
@Embeddable
public class ErpDetConvertidorId implements Serializable{
    ...
    public ErpDetConvertidorId(){
    }
 

    public ErpDetConvertidorId(String compania, String origen, String idconcgasto, BigDecimal noCaso) {
