...
@Entity
@Table(name = "ERP_FOLIOS_SOL_FONDOS")
public class ErpFoliosSolFondos implements java.io.Serializable {
    ...
    private ErpFoliosSolFondosId id;
    ...
    public ErpFoliosSolFondos(){
    
    }
    
    public ErpFoliosSolFondos(ErpFoliosSolFondosId id){
        
        this.id = id;
    
    }

    public ErpFoliosSolFondosId getId() {
        return id;
    }

    public void setId(ErpFoliosSolFondosId id) {
        this.id = id;
    }
